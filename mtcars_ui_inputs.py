...
def get_mtcars_inputs():
    return ui.panel_sidebar(
        ...
        ui.input_checkbox('MTCARS_COLOR_WHITE', 'WHITE', value=True),
        ui.input_checkbox('MTCARS_COLOR_RED', 'RED', value=True),
        ui.input_checkbox('MTCARS_COLOR_BLACK','BLACK', value=True),
        ui.input_checkbox('MTCARS_COLOR_GRAY', 'GRAY', value=True),
        ui.input_checkbox('MTCARS_COLOR_BLUE', 'BLUE', value=True),
        ui.input_checkbox('MTCARS_COLOR_SILVER', 'SILVER', value=True),                 
        ui.tags.hr(),
        ui.tags.section(
            ui.h3("MT Cars Table"),
